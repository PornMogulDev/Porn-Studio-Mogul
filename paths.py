...
def resource_path(relative_path):
    ...
    try:
        ...
        # If not running as a PyInstaller bundle, use the normal script directory
        base_path = os.path.dirname(os.path.abspath(__file__))

    return os.path.join(base_path, relative_path)

# NOW, UPDATE ALL YOUR PATHS TO USE THIS FUNCTION

# Base directories
BASE_DIR = os.path.dirname(os.path.abspath(__file__)) # This one can stay for saves
