...
class IGameController(Protocol):
    ...
    def calculate_shooting_bloc_cost(self, location_id: str, department_budgets: Dict[str, int], crew_assignments: Dict[str, Dict[str, Any]], picture_set_settings: Dict[str, Any]) -> int: ...
