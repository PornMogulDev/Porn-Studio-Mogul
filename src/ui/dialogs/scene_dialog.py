...
class SceneDialog(GeometryManagerMixin, QDialog):
    ...
    def _create_composition_group(self):
        ...
        protagonist_label = QLabel("Protagonist")
        protagonist_label.setToolTip("The talent's performance will have a bigger importance in the scene relative to non-protagonists")
        perf_layout.addWidget(protagonist_label)
